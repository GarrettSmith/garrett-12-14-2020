describe("Delete document", () => {
    ...
    it("Deletes the document", () => {
        ...
        cy.get(".Document-Tile").contains(filePath).parentsUntil(".Document-Tile").within(() => {
    ...
    it("Shows a message on errors", () => {
        cy.intercept({
            method: "DELETE",
            url: 'https://firebasestorage.googleapis.com/v0/b/garrett-12-14-2020.appspot.com/o/documents%2F',
        }, {
            statusCode: 400
        });
